...
function validNameA($str){
  if(empty($str)){
  $err = "Field required";
  }else if(!preg_match("/^[\p{Arabic}\- .?]{3,50}+$/u",$str)) {
...
function validNameE($str){
  if(empty($str)){
  $err = "Field required";
  }else if(!preg_match("/^[a-zA-Z\- .?]{3,50}+$/u",$str)) {
...
function validTitle($str){
  if(empty($str)){
  $err = "Field required";
  }else if(!preg_match("/^[\p{Arabic}a-zA-Z0-9\- .?]{3,50}+$/u",$str)) {
...
function validDesc($str){
  if(empty($str)){
  $err = "";
  }else if(!preg_match("/^[\p{Arabic}a-zA-Z0-9\- .?]{3,250}+$/u",$str)) {
