...
<head>
 <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Upload URL Lecture</title>
</head>
...
<div class="col-md-8">
  ...
  <div class="form-group">
    <label class="col-md-4 control-label" for="desc">Snap</label>
    <div class="col-md-4">
    <input id="snap" name="snap" type="file"  class="form-control input-md">

    </div>
    <label class="col-md-4 text-danger" id="fileErr" for="colleges"></label>
  </div>
  <div class="form-group">
    <label class="col-md-4 control-label" for="desc">Full URL</label>
    <div class="col-md-4">
    <input id="url" name="url" type="text"  class="form-control input-md">

    </div>
    <label class="col-md-4 text-danger" id="urlErr" for="colleges"></label>
  </div>
  <div class="form-group">
...
<script src="js/uploadURL.js"></script>
<script>
