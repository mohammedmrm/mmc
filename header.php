...
<head>
  ...
  <style type="text/css">
    ...
    body * :not(.fa):not(.la):not(.glyphicon):not(.prev):not(.next) {
...
<body>
  <?php if (file_exists("analyticstracking.php")) {
      ...
      <div class="col-xs-4">
        <div class="">
          <div class="input-group">
            ...
            <input type="text" placeholder="بحث ..." id="search-txt" class="search-txt" />
        ...
        <ul>
          ...
          <li class="more">
            ...
            <ul class="sub-list s-list1">
              ...
              <li>
                <a href="patents.php">براءات الاختراع</a>
              </li>
            </ul>
          </li>
          <li>
            <a href="Facultycomunty.php">
              <span class="glyphicon glyphicon-link"></span>
              خدمه مجتمع
            </a>
          </li>
